...
class UserinfoBasic extends Component {
  ...
  onPress() {
    ...
    // this.props.handleSubmit('熊智超',
    //   '430203199805034015' ,'上海', '虹口', '玫瑰园', 'jt',
    //   'yp', this.props.mobile, '啊啊', this.relaton1,
    //   '13787802057', '啊啊啊', this.relaton2, '13975317492');
    // console.info(this.relaton1);
  }
  render() {
    return (
