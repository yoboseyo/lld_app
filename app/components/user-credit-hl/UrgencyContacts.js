...
const relatonValue = ['COUPLE', 'PARENT', 'SIBBING', 'CHILD', 'COLLEAGUE', 'CLASSMATE', 'FRIEND'];
class UrgencyContacts extends Component {
  ...
  onPress() {
    this.props.onChangeRelaton1(relatonValue[this.state.relaton1]);
    this.props.onChangeRelaton2(relatonValue[this.state.relaton2]);
    this.props.onPress();
  }
        ...
        <View style={{ padding: 20 }}>
          ...
          <View >
            ...
            <View style={{ flexDirection: 'row', paddingRight: 5, marginTop: 10, marginBottom: 10, backgroundColor: '#fff', borderColor: '#cccccc', borderWidth: 1 }}>
              ...
              <Icon onPress={this.relaton1Visible} name='ios-arrow-down' size={25} color="#ccc" style={{alignSelf: 'flex-end' }} />
            </View>
          </View>
          <View>
          ...
          <View >
            ...
            <View>
              <View style={{ flexDirection: 'row', paddingRight: 5, marginTop: 10, marginBottom: 10, backgroundColor: '#fff', borderColor: '#cccccc', borderWidth: 1 }}>
                ...
                <Icon onPress={this.relaton2Visible}  name='ios-arrow-down' size={25} color="#ccc" style={{alignSelf: 'flex-end' }} />
              </View>
            </View>
          </View>
          <View >
