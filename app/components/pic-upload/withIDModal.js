...
export default class WithIDModal extends Component {
        ...
        >
          <ScrollView style={{marginTop: 20, backgroundColor: 'rgba(0,0,0,0.7)',}}>
            <View style={{margin: 20, backgroundColor: '#fff',padding: 15, borderRadius: 5,}}>
              ...
              <Text style={styles.txt}>
                2、用户需正面，免冠，未化妆，脸部未遮挡
              </Text>
              <Text style={styles.txt}>
                3、确保身份证上面的全部信息(包括文字和头像)清晰可辨认
              </Text>
              <Text style={styles.title}>参考样式</Text>
              <View style={styles.imgWrap}>
                <Image style={styles.img} source={require('image!withIDPic')} />
              </View>
...
const styles = StyleSheet.create({
  ...
  img: {
    ...
    height: (Dimensions.get('window').width - 82) * 1.1945,
    backgroundColor: '#000',
  },
  title: {
    fontSize: 24,
